...
<h1>Cracion de Contacto (CREATE)</h1>
...
<div>
anioPublicacion
<input type="text" name="anioPublicacion" id="anioPublicacion" placeholder="Ingrese el anioPublicacion" value="{{old('anioPublicacion') ?? $libro->anioPublicacion}}">
</div>
