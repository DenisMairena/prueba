...
class LibroController extends Controller
{
    ...
    {
    $libro = new Libro();
    return view('libros.crear', compact('libro'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('libro.index')
                         ->with('success', 'El libro fue creado exitosamente.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('libro.index')
                         ->with('success', 'El libro fue actualizado exitosamente.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('libro.index')
                         ->with('success', 'El libro se elimino exitosamente.');
    }
