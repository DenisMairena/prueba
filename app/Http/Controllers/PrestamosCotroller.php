...
class PrestamoController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('prestamos.crear', compact('libros', 'usuarios'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('PrestamoIndex')->with('success', 'Prestamo creado correctamente.');
    ...
    public function edit($id)
    {
        ...
        return view('prestamos.editar', compact('prestamo', 'libros', 'usuarios'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('PrestamoIndex')->with('success', 'Prestamo actualizar correctamente.');
